...
Plus simple markers (`340363`, `http://localhost:9080`, `Musterhaus Sonnenschein`, `nicole.neckermann@icloud.com`, etc.) used by the AvailabilityCalendar and various inline texts.
